...
<head>
  ...
  <!-- favicon  -->
  <link rel="shortcut icon" href="frontend/img/thumbnail.ico" type="image/x-icon">
  <!-- bootstrap css -->
  <link rel="stylesheet" href="frontend/css/plugins/bootstrap.min.css">
  <!-- font awesome css -->
  <link rel="stylesheet" href="frontend/css/plugins/font-awesome.min.css">
  <!-- swiper css -->
  <link rel="stylesheet" href="frontend/css/plugins/swiper.min.css">
  <!-- fancybox css -->
  <link rel="stylesheet" href="frontend/css/plugins/fancybox.min.css">
  <!-- mapbox css -->
  <link href="frontend/css/plugins/mapbox-style.css" rel='stylesheet'>
  <!-- main css -->
  ...
  <div class="qrt-app">
    <div class="qrt-preloader">
      <div class="qrt-preloader-content">
        <div class="qrt-logo">
          <img src="frontend/img/logo.svg" alt="Quarty">
        </div>
    ...
    <div class="qrt-top-bar">
      <a href="home-video.html" class="qrt-symbol qrt-cursor-scale qrt-anima-link"><img src="frontend/img/logo-sm.svg" alt="Symbol"></a>
    ...
    <div id="qrt-dynamic-content" class="qrt-dynamic-content">
          ...
          <div class="qrt-left">
            ...
            <div class="row">
              ...
              <div class="col-lg-3">
                ...
                <div class="qrt-team-member">
                  <a href="about-me.html" class="qrt-cursor-scale qrt-team-item qrt-anima-link">
                    <img src="frontend/img/team/tm1.jpg" alt="team member">
                  </a>
              ...
              <div class="col-lg-3">
                ...
                <div class="qrt-team-member">
                  <a href="about-me.html" class="qrt-cursor-scale qrt-team-item qrt-anima-link">
                    <img src="frontend/img/team/tm2.jpg" alt="team member">
                  </a>
                  <div class="qrt-team-member-description">
                    <div class="qrt-member-name">
              ...
              <div class="col-lg-3">
                ...
                <div class="qrt-team-member">
                  <a href="about-me.html" class="qrt-cursor-scale qrt-team-item qrt-anima-link">
                    <img src="frontend/img/team/tm3.jpg" alt="team member">
                  </a>
                  <div class="qrt-team-member-description">
                    <div class="qrt-member-name">
              ...
              <div class="col-lg-3">
                ...
                <div class="qrt-team-member">
                  <a href="about-me.html" class="qrt-cursor-scale qrt-team-item qrt-anima-link">
                    <img src="frontend/img/team/tm4.jpg" alt="team member">
                  </a>
                  <div class="qrt-team-member-description">
                    <div class="qrt-member-name">
                ...
                <div class="swiper-container qrt-testimonials-slider" style="overflow: visible">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <div class="qrt-testimonial">
                        <div class="qrt-testimonial-header">
                          <img src="frontend/img/testimonials/t1.jpg" alt="customer">
                    ...
                    <div class="swiper-slide">
                      <div class="qrt-testimonial">
                        <div class="qrt-testimonial-header">
                          <img src="frontend/img/testimonials/t2.jpg" alt="customer">
                          <div class="qrt-testimonial-name">
                    ...
                    <div class="swiper-slide">
                      <div class="qrt-testimonial">
                        <div class="qrt-testimonial-header">
                          <img src="frontend/img/testimonials/t3.jpg" alt="customer">
                          <div class="qrt-testimonial-name">
            ...
            <div class="row">
              <div class="col-lg-12">
                ...
                <div class="swiper-container qrt-brands-slider" style="overflow: visible">
                  <div class="swiper-wrapper">
                    <div class="swiper-slide">
                      <img src="frontend/img/brands/b1.svg" alt="brand">
                    </div>
                    <div class="swiper-slide">
                      <img src="frontend/img/brands/b2.svg" alt="brand">
                    </div>
                    <div class="swiper-slide">
                      <img src="frontend/img/brands/b3.svg" alt="brand">
                    </div>
                    <div class="swiper-slide">
                      <img src="frontend/img/brands/b4.svg" alt="brand">
                    </div>
                    <div class="swiper-slide">
                      <img src="frontend/img/brands/b5.svg" alt="brand">
                    </div>
                    <div class="swiper-slide">
                      <img src="frontend/img/brands/b6.svg" alt="brand">
                    </div>
                    <div class="swiper-slide">
                      <img src="frontend/img/brands/b7.svg" alt="brand">
                    </div>
                  </div>
                </div>
      ...
      <!-- anime js -->
      <script src="frontend/js/plugins/anime.min.js"></script>
      <!-- swiper js -->
      <script src="frontend/js/plugins/swiper.min.js"></script>
      <!-- progressbar js -->
      <script src="frontend/js/plugins/progressbar.min.js"></script>
      <!-- smooth scrollbar js -->
      <script src="frontend/js/plugins/smooth-scrollbar.min.js"></script>
      <!-- overscroll js -->
      <script src="frontend/js/plugins/overscroll.min.js"></script>
      <!-- isotope js -->
      <script src="frontend/js/plugins/isotope.min.js"></script>
      <!-- fancybox js -->
      <script src="frontend/js/plugins/fancybox.min.js"></script>
      <!-- swup js -->
      <script src="frontend/js/plugins/swup.min.js"></script>
      <!-- mapbox js -->
      <script src="frontend/js/plugins/mapbox.min.js"></script>
